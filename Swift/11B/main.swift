...
func step() -> (Int, Bool) {
    ...
    return (totalFlashes, didAllFlash)
}
...
// Add 1, if == 10 didAffectNeighbor = false, willFlash = true

// Go through flashes and didAffectNeighbor = true, repeat until no willFlashes left,

// Reset willFlashes to false and Reset to 0 if willFlash was true
